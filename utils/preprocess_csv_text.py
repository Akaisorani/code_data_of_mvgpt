...
sql_dataset["train"]=sql_dataset["train"].map(lambda x: {'exp': x['exp'].replace('\t',' ').replace('new_dmp','nd').replace('taobao_dmp_dp','tdd')})
...
sql_dataset["train"]=sql_dataset["train"].filter(lambda x: x['idtfr'].strip() and x['idtfr'].strip()!="nd.crowd_materialize_view_for_dmp.crowd_id")
sql_dataset["test"]=sql_dataset["test"].filter(lambda x: x['idtfr'].strip() and x['idtfr'].strip()!="nd.crowd_materialize_view_for_dmp.crowd_id")
...
'1.15':"""淘宝年货节
请介绍淘宝年货节？
淘宝年货节是淘宝网举办的一项促销活动，主要面向春节前后的消费者，旨在满足消费者在春节前购买年货的需求。
淘宝年货节一般在春节前一个月左右开始，持续时间大约为一个月，为消费者提供更多优惠和便利，让他们可以轻松购买到所需的年货。
除了淘宝网，其他电商平台也会举办类似的年货节活动，以满足消费者的需求。

淘宝年货节什么货品卖的好？
淘宝年货节卖的最好的货品一般包括：食品、礼品、服装、家居用品、电器、美妆护肤等。
食品是淘宝年货节上最受欢迎的商品，包括零食、酒水、调味品、糕点等，都是消费者在春节期间必备的食品。
礼品也是淘宝年货节上的一大热门，包括节日礼品、年货礼盒、新年装饰品等，都是消费者在春节期间送礼的首选。
服装也是淘宝年货节上的一大热门，包括男女装、鞋子、配饰等，都是消费者在春节期间换新装的首选。
家居用品也是淘宝年货节上的一大热门，包括床上用品、厨房用品、家居装饰品等，都是消费者在春节期间换新家的必备。
电器也是淘宝年货节上的一大热门，包括电视、冰箱、洗衣机、空调等，都是消费者在春节期间更换新家电的首选。
美妆护肤也是淘宝年货节上的一大热门，包括护肤品、彩妆、美发产品等，都是消费者在春节期间保养自己的必备。""",


'3.18':"""女王节日大促
3.18女王节日大促是中国最大的女性购物节，它是由阿里巴巴旗下的淘宝网发起的，旨在为女性消费者提供更多的优惠和便利，以满足她们在购买服装、美妆、家居等商品时的需求。
3.18女王节日大促已经成为中国女性消费者最喜爱的购物节之一，它不仅提供了更多的优惠和便利，还为女性消费者提供了一个良好的购物环境，让她们可以轻松购买到所需的商品。

3.18哪些货品卖的好？
3.18女王节日大促卖的最好的货品一般包括：服装、美妆、家居用品等。
服装是3.18女王节日大促上最受欢迎的商品，包括女装、内衣、鞋子、配饰等，都是消费者在购物节期间购买的首选。
美妆也是3.18女王节日大促上的一大热门，包括护肤品、彩妆、美发产品等，都是消费者在购物节期间购买的美容产品。
家居用品也是3.18女王节日大促上的一大热门，包括床上用品、厨房用品、家居装饰品等，都是消费者在购物节期间购买的家居用品。
此外，3.18女王节日大促上还会有一些特色商品，例如女性健康用品、女性时尚饰品等，也是消费者在购物节期间购买的热门商品。""",

'6.18':"""年中大促
6.18年中大促是中国最大的年中购物节，由阿里巴巴旗下的淘宝网发起，每年6月18日左右举行。6.18年中大促是中国消费者最受欢迎的购物节之一，它旨在为消费者提供更多的优惠和便利，以满足他们在购买服装、美妆、家居等商品时的需求。
...
'8.8':"""会员节大促
8.8会员节大促是中国最大的会员购物节，由阿里巴巴旗下的淘宝网发起，每年8月8日左右举行。8.8会员节大促是中国消费者最受欢迎的购物节之一，它旨在为淘宝网的会员提供更多的优惠和便利，以满足他们在购买服装、美妆、家居等商品时的需求。
...
'11.11':"""购物狂欢大促
11.11购物狂欢大促是中国最大的购物节，由阿里巴巴旗下的淘宝网发起，每年11月11日左右举行。11.11购物狂欢大促是中国消费者最受欢迎的购物节之一，它旨在为消费者提供更多的优惠和便利，以满足他们在购买服装、美妆、家居等商品时的需求。
