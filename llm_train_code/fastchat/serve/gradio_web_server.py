...
from fastchat.serve.chains.knowledge_search import get_prompt_knowledge, get_prompt_knowledge_top_k
...
def http_bot(state, model_selector, temperature, max_new_tokens, request: gr.Request):
    ...
    try:
        if 'analyticai' in model_name and ('帮助' in prompt or 'help' in prompt) and '提案分析帮助' not in prompt:
...
def build_single_model_ui():
    ...
    return state, model_selector, chatbot, textbox, send_btn, button_row, parameter_row, plot
