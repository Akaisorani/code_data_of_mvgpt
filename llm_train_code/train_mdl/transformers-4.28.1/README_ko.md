...
1. **[MGP-STR](https://huggingface.co/docs/transformers/model_doc/mgp-str)** (XXX Research 에서 제공)은 Peng Wang, Cheng Da, and Cong Yao.의 [Multi-Granularity Prediction for Scene Text Recognition](https://arxiv.org/abs/2209.03592)논문과 함께 발표했습니다.
