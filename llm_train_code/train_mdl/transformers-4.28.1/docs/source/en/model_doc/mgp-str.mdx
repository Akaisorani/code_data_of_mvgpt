...
- This model was contributed by [yuekun](https://huggingface.co/yuekun). The original code can be found [here](https://github.com/XXXResearch/AdvancedLiterateMachinery/tree/main/OCR/MGP-STR).
